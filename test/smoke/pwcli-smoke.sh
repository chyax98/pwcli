...
node test/fixtures/servers/deterministic-server.js "$PORT" >"$SERVER_LOG" 2>&1 &
SERVER_PID="$!"
...
log "bootstrap apply"
bootstrap_json="$(run_json bootstrap-apply bootstrap apply --session "$SESSION_NAME" --init-script ./test/fixtures/code/bootstrap-init.js --headers-file "$HEADERS_FILE")"
...
bootstrap_verify_json="$(run_json bootstrap-verify code --session "$SESSION_NAME" --file ./test/fixtures/code/bootstrap-verify.js)"
...
code_json="$(run_json diagnostics-code code --session "$SESSION_NAME" --file ./test/fixtures/code/diagnostics-verify.js)"
...
diagnostics_restore_json="$(run_json diagnostics-restore code --session "$SESSION_NAME" --file ./test/fixtures/code/diagnostics-verify.js)"
...
route_patch_verify_json="$(run_json route-patch-verify code --session "$SESSION_NAME" --file ./test/fixtures/code/route-patch-verify.js)"
