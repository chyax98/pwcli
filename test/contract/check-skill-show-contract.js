...
if (
	...
	throw new Error(
		`unexpected skill refs payload: ${JSON.stringify(refsPayload, null, 2)}`,
	);
}
...
if (
	...
	throw new Error(
		`unexpected skill show payload: ${JSON.stringify(mainPayload, null, 2)}`,
	);
}
...
if (
	...
	throw new Error(
		`unexpected skill show ref payload: ${JSON.stringify(refPayload, null, 2)}`,
	);
}
...
if (
	...
	throw new Error(
		`unexpected skill show full payload: ${JSON.stringify(fullPayload, null, 2)}`,
	);
}
