...
| `screenshot` | `proven` | 2026-05-04 artifact focused check 覆盖 page/full-page、selector、annotated、snapshot ref screenshot，均写出非空 PNG |
| `pdf` | `proven` | 2026-05-04 artifact focused check 覆盖 `pw pdf --path`，输出非空 PDF |
