...
| `session list` | `documented` | skill 和 failure recovery 记录 list / `--with-page` / `--attachable` |
| `session status` | `documented` | skill 和 failure recovery 记录 status 作为复查入口 |

**状态分布：** proven 4 / documented 2 / experimental 0
