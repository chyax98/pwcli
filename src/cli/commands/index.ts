...
export default {
	...
	drop: () => import("./drop.js").then((m) => m.default),
	...
	"check-injection": () =>
		import("./check-injection.js").then((m) => m.default),
	...
	"control-state": () =>
		import("./control-state.js").then((m) => m.default["control-state"]),
	takeover: () => import("./control-state.js").then((m) => m.default.takeover),
	"release-control": () =>
		import("./control-state.js").then((m) => m.default["release-control"]),
