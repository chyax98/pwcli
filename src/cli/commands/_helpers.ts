...
export function actionTarget(args: CliArgs, positionalRef?: string) {
	const semantic = buildSemanticTarget(
		args as Parameters<typeof buildSemanticTarget>[0],
	);
...
export async function sourceFromArgs(
