...
export default defineCommand({
  ...
  args: { ...actionArgs, assertion: { type: "enum", options: assertions, description: "Assertion: text, text-absent, url, visibility, enabled, checked, or count" }, contains: { type: "string", description: "URL substring", valueHint: "text" }, equals: { type: "string", description: "Expected exact value", valueHint: "value" }, matches: { type: "string", description: "Expected regex", valueHint: "regex" }, min: { type: "string", description: "Minimum count", valueHint: "n" }, max: { type: "string", description: "Maximum count", valueHint: "n" } },
  async run({ args }) {
