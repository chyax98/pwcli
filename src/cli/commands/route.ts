...
const add = defineCommand({
  ...
  args: { ...sharedArgs, abort: { type: "boolean", description: "Abort matched requests" }, body: { type: "string", description: "Fulfill body", valueHint: "text" }, "body-file": { type: "string", description: "Fulfill body file", valueHint: "path" }, status: { type: "string", description: "Fulfill status", valueHint: "code" }, "content-type": { type: "string", description: "Fulfill content type", valueHint: "mime" }, "headers-file": { type: "string", description: "Fulfill headers JSON file", valueHint: "path" }, "merge-headers-file": { type: "string", description: "Merge response headers JSON file", valueHint: "path" }, "inject-headers-file": { type: "string", description: "Inject request headers JSON file", valueHint: "path" }, "match-body": { type: "string", description: "Request body substring matcher", valueHint: "text" }, "match-query-file": { type: "string", description: "Match query JSON file", valueHint: "path" }, "match-headers-file": { type: "string", description: "Match headers JSON file", valueHint: "path" }, "match-json-file": { type: "string", description: "Match JSON body file", valueHint: "path" }, "patch-json": { type: "string", description: "Merge patch JSON into upstream JSON response", valueHint: "json" }, "patch-json-file": { type: "string", description: "Merge patch JSON file", valueHint: "path" }, "patch-text-file": { type: "string", description: "Text replacement JSON file", valueHint: "path" }, "patch-status": { type: "string", description: "Patch response status", valueHint: "code" }, method: { type: "string", description: "HTTP method filter", valueHint: "method" } },
  async run({ args }) {
